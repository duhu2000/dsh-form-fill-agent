...
for(const name of ['qcc-field-contracts','form-fill-core','qcc-form-fill-provider','dsh-form-fill-agent'])assert.equal((await lstat(join(directory,'node_modules',name))).isSymbolicLink(),false);
