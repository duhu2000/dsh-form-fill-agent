...
## UX-49 采用补充（Unreleased，2026-09-15）

采用 DSH-UX-001 v1.5.6 的 UX-49、§11.1、§14；保留 UX-48。范围、原生接口、一次性标记与分层证据见 [UX49-INITIAL-DRAFT.md](UX49-INITIAL-DRAFT.md)。只在入口新建原生业务 Session 初始化；独立 `/form-fill/` 不参与。
