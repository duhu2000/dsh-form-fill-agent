...
最终发布结果：已发布主包 0.2.16 与内核 0.2.10，CI、registry 和双 DSH 隔离安装验收通过，市场 PR 已更新。详见 [发布记录](RELEASE-0.2.16.md)。以下“未发布”与“不修改市场”是初次本地验收阶段的历史边界。

发布推进补记：用户随后授权 commit、push、tag、npm 与市场 PR 更新。因远端已经发布文档版 0.2.15，本轮改用主包 **0.2.16**、内核 **0.2.10**，保留远端文档提交。下文“未发布”描述的是初次本地验收时点；最终发布以 0.2.16 CI 及 registry 为准。
