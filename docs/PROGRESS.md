...
当前主包正式版本 **0.2.2**，共享内核与 Provider 保持 **0.2.0**，均已发布 npm。首页快捷卡片与右侧工作台样式已统一，工作台连续调宽已交付并通过 OIDC 自动发布；98 项测试、六组 CI、界面矩阵、registry 完整性、README、三模板独立安装及双宿主安装/卸载验收通过。最新清洗 0.8.9 兼容证据来自 0.2.0，本轮未修改共享内核或 Provider。发布回执见 [RELEASE-0.2.2.md](RELEASE-0.2.2.md)。正式编号不替代本人签收、Microsoft Excel 验收或市场维护者合并。
