...
当前主包正式版本 **0.2.7**，共享内核与 Provider 保持 **0.2.0**，均已发布 npm。本轮默认展开分析网格并取消主包隐式 100 次调用上限，支持显式 DSH_FORM_FILL_MAX_CALLS 配置，已通过 OIDC 自动发布；101 项测试、六组 CI、配置及原生界面回归、registry 完整性、README、三模板独立安装及双宿主安装/卸载验收通过。最新清洗 0.8.9 兼容证据来自 0.2.0，本轮未修改共享内核或 Provider。发布回执见 [RELEASE-0.2.7.md](RELEASE-0.2.7.md)。正式编号不替代本人签收、Microsoft Excel 验收或市场维护者合并；历史客户表格未自动重新处理。
