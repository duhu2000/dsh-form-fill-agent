...
当前正式版本 **0.2.0**，主包、共享内核与 Provider 三包同版，已发布 npm。98 项测试、六组 CI、最新清洗 0.8.9 兼容、registry 完整性、README、三模板独立安装及双宿主安装/卸载验收通过；alpha.11 工作台菜单及 alpha.10 XLSX 导入兼容修复保留。发布回执见 [RELEASE-0.2.0.md](RELEASE-0.2.0.md)。正式编号不替代本人签收、Microsoft Excel 验收或市场维护者合并。
