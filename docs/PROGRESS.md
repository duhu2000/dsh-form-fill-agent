...
当前已发布版本 **0.2.16**，内核 **0.2.10**，Provider **0.2.1**，字段契约 **0.1.0**。111 项测试、六组平台 CI、registry 验收及两条 DSH 基线隔离安装/卸载通过。见 [0.2.16 发布说明](RELEASE-0.2.16.md)。市场 PR #4487 已更新为本版本，仍待维护者审核合并。

以下为先前阶段记录，不作为当前版本依据。

当前主包正式版本 **0.2.9**，共享内核 **0.2.8**，Provider **0.2.0**，均已发布 npm。本轮统一企查查蓝向导样式与服务引导文案，103 项测试、32 组向导布局、原生界面回归、六组 CI 及双宿主隔离安装卸载通过。详见 [RELEASE-0.2.9.md](RELEASE-0.2.9.md)。0.2.8 的表格兼容边界保持不变；正式用户、Excel 桌面验收和市场流程仍独立跟踪。
