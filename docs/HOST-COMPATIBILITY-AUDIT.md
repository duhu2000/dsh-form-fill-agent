...
四产品全部候选共存由总账协调，本轮只验证 AI 填表与侧栏/context。未验证真实模型、真实 MCP 权限/费用、全部浮窗/底部组合。候选包尚不在 npm；发布时需保留新版本号，不能覆盖0.2.23或移动既有标签。回滚需恢复完整版本组合及升级前任务目录备份。
