...
当前已发布版本为 0.1.0-alpha.6，npm / GitHub Latest 一致：企查查蓝深浅色、左上入口、专属品牌首页、四步字段向导、手写草稿保护和结果筛选。字段范围实际约束查询和填写，支持六类工商字段、来源追溯、未完成清单和任务恢复。没有 LLM 猜值；已有内容默认保留。发布验收见 [U4 验收](docs/U4-UI-ACCEPTANCE.md)。
